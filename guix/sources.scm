...
(list
  ...
  ;; boost-numeric-conversion 1.92.0
  (origin
    (method git-fetch)
  ...
  (origin
    ...
    (sha256 (base32 "0gqrzjm17m1f07qj0x0xismdvg9a4vys4c267m54dghjgss0bfxxlp449jmpbr7snw0fzya8qsc2l01ag9z7bzgiggv2hp6mxnfgwsd")))
  ;; ogg 1.3.5
  (origin
    (method git-fetch)
  ...
  (origin
    ...
    (sha256 (base32 "03nnlxq9dxaa8vlr3852x2shnpcrcpp56nz5zzpz1jjd7wabf1jm")))
  ;; opus 1.5.2
  (origin
    (method git-fetch)
  ...
  (origin
    ...
    (sha256 (base32 "0cdsviyig15jb8kn93w16pbdnj1pg3p49y560xk0k4ay09i5p2zbj6j5h4nafnr4rxzg38zyhrcsj0xdayn27qkn6gd87b79qcq45lw")))
  ;; skiff 
  (origin
    (method git-fetch)
    (uri (git-reference (url "https://github.com/j4niwzis/skiff.git")
                        (commit "d22f098c914e4aff1163ecedf5da756e176ae1ee")))
    (sha256 (base32 "1bnlmvn6fdvs1kpdglad6ldycy8p2sr7lfjqk99ggr80frpa5rsh")))
  ;; skiff-widgets 
  (origin
    (method git-fetch)
