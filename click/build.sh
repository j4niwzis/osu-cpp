...
if [ ! -f "$prefix/lib/glfw-mir-3.2-v6.ready" ]; then
  ...
  if [ ! -f "$sources/glfw-mir/.osu-mir-patch-v7" ]; then
    ...
    touch "$sources/glfw-mir/.osu-mir-patch-v7"
  fi
  ...
  touch "$prefix/lib/glfw-mir-3.2-v6.ready"
fi
