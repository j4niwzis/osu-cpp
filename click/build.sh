...
if [ ! -f "$prefix/lib/glfw-mir-3.2-v4.ready" ]; then
  ...
  if [ ! -f "$sources/glfw-mir/.osu-mir-patch-v5" ]; then
    ...
    touch "$sources/glfw-mir/.osu-mir-patch-v5"
  fi
  ...
  touch "$prefix/lib/glfw-mir-3.2-v4.ready"
fi
