...
if [ ! -f "$prefix/lib/glfw-mir-3.2-v3.ready" ]; then
  ...
  if [ ! -f "$sources/glfw-mir/.osu-mir-patch-v4" ]; then
    ...
    touch "$sources/glfw-mir/.osu-mir-patch-v4"
  fi
  ...
  touch "$prefix/lib/glfw-mir-3.2-v3.ready"
fi
