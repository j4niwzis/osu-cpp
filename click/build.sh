...
if [ ! -f "$prefix/lib/glfw-mir-3.2-v5.ready" ]; then
  ...
  if [ ! -f "$sources/glfw-mir/.osu-mir-patch-v6" ]; then
    ...
    touch "$sources/glfw-mir/.osu-mir-patch-v6"
  fi
  ...
  touch "$prefix/lib/glfw-mir-3.2-v5.ready"
fi
