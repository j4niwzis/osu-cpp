...
{ pkgs ? import <nixpkgs> { } }:
{
  ...
  mpg123 = pkgs.fetchurl {
    ...
    sha256 = "4df3e76cafe642b1df8befaff3d3530150c13446ca7f07b8d527af5b6522e4d2dedd025a3f095f23a51e2318d17e1395de6e55c70e3a90f80017ea0955fe8c1f";
  };  # 1.32.10
  ogg = pkgs.fetchgit {
  ...
  skia = pkgs.fetchurl {
    ...
    sha256 = "9c1682194e671dd49eb1131f61bd6a1d48cd32f41f8df77b26d93a65092cd2c8f5c52d3101afc804b303537c2277bc1ba46deb9ac047b2132d59c28b3e6edd18";
  };  # 153
  skiff = pkgs.fetchgit {
    url = "https://github.com/j4niwzis/skiff.git";
    rev = "d22f098c914e4aff1163ecedf5da756e176ae1ee";
    sha256 = "1bnlmvn6fdvs1kpdglad6ldycy8p2sr7lfjqk99ggr80frpa5rsh";
  };  # 
